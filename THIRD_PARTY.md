...
- Media contract: local observations are sent as base64 `image_url`, `video_url`, or `input_audio` message parts. Only bounded active-perception/refinement media is sent.
